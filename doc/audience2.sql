...
-- Export de la structure de la base pour bb2_audience
CREATE DATABASE IF NOT EXISTS `bb2_audience` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `bb2_audience`;
...
-- Export de données de la table bb2_audience.affiliates: ~58 rows (environ)
